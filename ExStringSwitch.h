...
#define STR_CASE_I(Str) \
		{\
			static const auto h = __StrSwitchStrCase(Str);\
			case h:\
			if((___switch_hash == h) && (memicmp(Str, ___switch_str, h >> 32) != 0)) break;\
		}

#define STR_SWITCH_DEFAULT default:
